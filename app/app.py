...
def output_thingy(data_input, m):
    ...
    st.write('อะไรนะ คุณกำลังคิดว่าโมเดลของเราประเมินไม่แม่นอยู่รึเปล่า?')
    st.write('ถ้าใช่ คุณสามารถช่วยให้โมเดลของเราประเมินแม่นขึ้นได้โดยการทำแบบสอบถามสั้นๆนี้ได้')
    st.markdown('👉 <a href="https://forms.gle/5V6WxnELVW2TaFaT8">ทำแบบสอบถามช่วยพัฒนาโมเดล</a> 👈',unsafe_allow_html=True)
